...
export const SeekLogin=(props)=>{
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity
                onPress={()=>props.navigation.navigate("OtpPageSeek")}>
            ...
            <TouchableOpacity
                onPress={()=>props.navigation.navigate("SeekSignUp")}>
...
export const OtpPageSeek=(props)=>{
    return(
        <View style={styles.container}>
            <Text 
            style={{
